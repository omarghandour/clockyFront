...
const Page = () => {
  ...
  return (
    <div className="min-h-screen bg-main paddingX flex flex-col items-center text-pretty p-6 w-full mt-20 md:mt-12 shadow-md rounded-lg text-main paddingX mx-auto md:p-8 ">
